...
def main(cmd_opt):
    ...
    #wandb.init(settings=wandb.Settings(start_method="fork")) - https://docs.wandb.ai/guides/track/launch#init-start-error
...
#https://docs.wandb.ai/ref/cli/wandb-offline
    #needs to be done via .yaml arg given main setup
    #opt['use_wandb_offline'] = True
